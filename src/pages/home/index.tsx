...
const techStack = [
	...
	{ tech: "MyBatis", version: "3.5.0", description: "ORM 框架" },
	{
		tech: "MyBatisPlus",
		version: "3.5.3.1",
		description: "基于 MyBatis 的增强工具",
	},
	{ tech: "Swagger-UI", version: "4.0.0", description: "API 文档生成工具" },
	{
		tech: "Redisson",
		version: "3.19.3",
		description: "Redis 客户端，支持分布式锁",
	},
		...
		<div className="space-y-4">
			...
			>
				<Typography.Paragraph>
					一个基于 Spring Boot、Spring OAuth2.0、MyBatis、Redis
					打造的轻量级、前后端分离、支持完整 SKU 与下单流程的开源商城。
				</Typography.Paragraph>
				<Typography.Paragraph>
				...
				<Typography.Paragraph>
					<Typography.Text code>mall4j</Typography.Text>{" "}
					致力于为中小企业提供一个完整、易维护的开源电商系统，后台包含商品管理、订单管理、运费模板、规格管理、会员管理、运营管理、内容管理、统计报表、权限管理、设置等模块。
				</Typography.Paragraph>
